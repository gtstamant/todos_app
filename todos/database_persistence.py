...
class DatabasePersistence:
    ...
    def update_list_by_id(self, list_id, new_title):
        ...
        logger.info("Executing query: %s with id: %s and new_title: %s",
    ...
    def create_new_todo(self, list_id, todo_title):
        ...
        logger.info("Executing query: %s with title: %s and id: %s",
    ...
    def mark_all_todos_completed(self, list_id):
        ...
        logger.info(logger.info("Executing query: %s with list_id: %s",
                    query, list_id))
        with self._database_connect() as conn:
            with conn.cursor() as cursor:
                cursor.execute(query, (list_id,))